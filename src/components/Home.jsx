  ...
  return (
    <>
      ...
      <div id="home" className="min-h-screen overflow-hidden bg-black relative">
        ...
        <div ref={contentContainerRef} className="relative z-20 w-full max-w-7xl mx-auto min-h-screen flex items-center px-4 md:px-8 py-24 md:py-0">
          <div className="flex flex-col md:flex-row items-center justify-between w-full gap-10 md:gap-12">
            ...
            <div className="w-full md:w-3/5 flex flex-col items-center md:items-start text-center md:text-left order-2 md:order-1">
              ...
              >
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-black mb-4 tracking-tighter leading-tight md:leading-none">
                ...
                <div className="flex items-center gap-3 mb-6 justify-center md:justify-start">
                  <span className="px-4 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 text-[10px] sm:text-sm font-mono tracking-tight shadow-[0_0_15px_rgba(59,130,246,0.1)]">
                    B.Tech IT @ Kongu Engineering College
                  </span>
                </div>

                <h3 className="text-xl md:text-3xl text-white/90 font-light mb-6 tracking-wide">
                ...
                <p className="text-sm sm:text-base md:text-xl max-w-xl text-white/60 leading-relaxed mb-8 px-4 md:px-0">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-6 mb-10 justify-center md:justify-start">
                  <Tooltip text="GitHub Profile">
                    <a href="https://github.com/DHARANISH45" target="_blank" rel="noopener noreferrer" className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-white hover:bg-blue-500/20 hover:border-blue-500/30 transition-all duration-300">
                  ...
                  <Tooltip text="LinkedIn Connect">
                    <a href="https://www.linkedin.com/in/dharanish-sl/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-white hover:bg-indigo-500/20 hover:border-indigo-500/30 transition-all duration-300">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="w-full md:w-2/5 flex justify-center items-center relative order-1 md:order-2 mb-10 md:mb-0">
