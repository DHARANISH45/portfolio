...
const Skills = () => {
  ...
  const toolsSkills = [
    ...
    { name: "AWS (IAM, S3, EC2)", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original.svg" },
  ...
  // Remove high-performance GSAP animations for better performance
  // ...existing code...
